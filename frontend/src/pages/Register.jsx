...
export default function Register() {
    ...
    return (
        <div className="min-h-screen bg-dark-pure flex items-center justify-center relative overflow-hidden px-4">
            <div className="gradient-orb w-80 h-80 bg-accent-olive top-[15%] right-[10%] animate-float" />
            <div className="gradient-orb w-64 h-64 bg-calm-blue bottom-[15%] left-[10%] animate-pulse-soft" />
            ...
            <div className="w-full max-w-md relative z-10 animate-slide-up">
                ...
                <div className="glass-card p-8">
                    <h2 className="text-xl font-semibold text-text-primary mb-1 text-center">Create your space</h2>
                    <p className="text-sm text-text-muted text-center mb-6">
                        A private, safe place for your thoughts
                    </p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button type="submit" disabled={isLoading} className="btn-primary w-full">
                            {isLoading ? 'Creating your space...' : 'Start journaling'}
                        </button>
                    </form>

                    <p className="text-xs text-text-muted text-center mt-6">
                        Already have an account?{' '}
                        <Link to="/login" className="text-calm-blue hover:text-calm-blue-deep transition-colors">
                            Sign in
                        </Link>
                    </p>
                </div>
                ...
                <p className="text-xs text-text-muted text-center mt-4">
                    🛡️ We never share or sell your journal data
                </p>
            </div>
        </div>
    );
